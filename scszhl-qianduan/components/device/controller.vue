      ...
      <el-container>
        ...
        <el-main>
          ...
          <el-button type="success" @click="insertForm = true">
            <i class="el-icon-connection el-icon--left"></i>添加控制器设备
          </el-button>
          <br />
          <br />
          <!-- 设备列表 -->
                    ...
                    <el-table-column prop label width="150">
                      <template scope="scope">
                        ...
                        <el-button
                          ...
                          icon="el-icon-delete"
                          circle
                          @click="deleteController($index, scope.row.id)"
                        ></el-button>
                      </template>
                    </el-table-column>
                  </el-table>
          ...
          <template>
            <el-dialog title="修改传感器信息" :visible.sync="updateForm">
              <el-form :model="updateController">
                <el-form-item label="设备id" :disabled="true" v-if="show">
                  <el-input v-model="updateController.id" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备编号" :disabled="true">
                  <el-input v-model="updateController.code" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备时间">
                  <el-date-picker
                    type="date"
                    placeholder="选择日期"
                    v-model="updateController.time"
                    format="yyyy-MM-dd"
                    value-format="yyyy-MM-dd"
                  ></el-date-picker>
                </el-form-item>
                <el-form-item label="设备类型">
                  <el-input v-model="updateController.type" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备数值">
                  <el-input v-model="updateController.value" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备标记">
                  <el-input v-model="updateController.flag" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备地点">
                  <el-input v-model="updateController.address" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备状态">
                  <el-select v-model="updateController.status" placeholder="请选择">
          ...
          <template>
            <el-dialog title="添加传感器" :visible.sync="insertForm">
              <el-form :model="insertController">
                <el-form-item label="设备编号" :disabled="true">
                  <el-input v-model="insertController.code" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备时间">
                  <el-date-picker
                    type="date"
                    placeholder="选择日期"
                    v-model="insertController.time"
                    format="yyyy-MM-dd"
                    value-format="yyyy-MM-dd"
                  ></el-date-picker>
                </el-form-item>
                <el-form-item label="设备类型">
                  <el-input v-model="insertController.type" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备数值">
                  <el-input v-model="insertController.value" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备标记">
                  <el-input v-model="insertController.flag" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备地点">
                  <el-input v-model="insertController.address" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="设备状态">
                  <el-select v-model="insertController.status" placeholder="请选择">
                    <el-option label="启用" value="enable"></el-option>
                    <el-option label="禁用" value="disable"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="设备客户端">
                  <el-select
                    v-model="insertController.clientId"
                    placeholder="请选择"
                    @focus="selectClient"
                  >
...
export default {
  ...
  methods: {
    ...
    //查询客户端对应传感器
    selectController(i) {
      this.getRequest("/device/listController", {
        id: i
      }).then(resp => {
        if (resp && resp.status == 200) {
          var data = resp.data;
    ...
    handleEdit(row, _index) {
      //记录索引
      this.controllerDataIndex = _index;
      //记录数据
      this.updateController = row;
      //显示弹窗
    ...
    editDone(event) {
      ...
      this.putRequest("/device/updateController", this.updateController).then(resp => {
    ...
    //插入传感器信息
    insertDone() {
      this.postRequest("/device/insertController", this.insertController).then(resp => {
        console.log(resp.data);
      });
    ...
    deleteController(index, i) {
      ...
      this.$confirm("此操作将永久删除该传感器, 是否继续?", "提示", {
        ...
        type: "warning"
          ...
          this.deleteRequest("/device/deleteController", {
            id: i
          }).then(resp => {
            console.log(resp.data);
